 ...
 *                  (____/ 
 *  Use NodeMCU to send Potentiometer sensor value to remote MQTT client
 * Tutorial URL http://osoyoo.com/2017/05/16/nodemcu-lesson-13-potentiometer-mqtt/
...
void setup() {
  Serial.begin(115200);
  setup_wifi();
  client.setServer(mqtt_server, 31223);//the default mqqt port is 1883.
